...
logo = """           \033[1;37m                                 
 ______                    _____                      __  __    _                _   __________  ____  ____ 
 /_  __/_  ______  ___     / ___/____  ____ ___  ___  / /_/ /_  (_)___  ____ _   / | / /  _/ __ \/ __ \/ __ )
  / / / / / / __ \/ _ \    \__ \/ __ \/ __ `__ \/ _ \/ __/ __ \/ / __ \/ __ `/  /  |/ // // /_/ / / / / __  |
 / / / /_/ / /_/ /  __/   ___/ / /_/ / / / / / /  __/ /_/ / / / / / / / /_/ /  / /|  // // _, _/ /_/ / /_/ / 
/_/  \__, / .___/\___/   /____/\____/_/ /_/ /_/\___/\__/_/ /_/_/_/ /_/\__, /  /_/ |_/___/_/ |_|\____/_____(_)
    /____/_/_________  ____  ____     __________                     /____/                                  
      / | / /  _/ __ \/ __ \/ __ )   / ____/ __ )                                                            
     /  |/ // // /_/ / / / / __  |  / /_  / __  |                                                            
    / /|  // // _, _/ /_/ / /_/ /  / __/ / /_/ /                                                             
   /_/ |_/___/_/ |_|\____/_____/  /_/   /_____/                                                              
                                                                                                             

\033[1;37m------------------------------------------------
\033[1;37m Owner   :            NIROB FB
\033[1;37m Facebook:            RJ Nirob
\033[1;37m Github  :            NIROB
...
def fb nirob():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://https://www.facebook.com/rj.nirob.35175?mibextid=aejMdD
        pass
    elif select =='F':
        os.system(https://youtube.com/@Nikotin992?si=wFtO8_l6GOcVUbnE)
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    os.system('touch ' +nirob)
    os.system('sort -r '+ssb+' | uniq > '+nirob)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + Nirob )
    print(47*'-')
...
def cutter():
    ...
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +Nirob)
    os.system('sort -r '+Nirob+' | uniq > '+Nirob)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + Nirob)
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
